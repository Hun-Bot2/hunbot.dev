...
Agent365-ai Draw.io skill을 사용 -> 시스템 아키텍쳐부터 User Flow까지 문서로 깔끔하게 구현하기

Claude Design으로 만들어둔 UI/UX 시스템을 다운 받아 Next.js 구조에 맞게 리팩토링을 한 뒤
Taste Skill을 사용해서 디자인 다듬기
