...
export const ui = {
  ko: {
    ...
    'library.title': '라이브러리',
    'library.subtitle': 'AI-native builders를 위한 사람이 검수한 리소스 허브',
    'library.description': '디자인, 바이브 코딩, 개발 문서, AI 논문, 유용한 피드, 발표 자료를 사람의 검토를 거쳐 정리하는 정적 라이브러리입니다.',
    'library.human-reviewed': '사람이 검수한 공개 데이터',
    'library.sections.title': 'Library 섹션',
    'library.sections.description': '섹션별 페이지에서 검수된 공개 샘플을 더 자세히 살펴볼 수 있습니다.',
    ...
    'library.section.ai-papers.description': '빌더 관점에서 읽을 가치가 있는 AI 논문 카드를 사람의 요약과 함께 모읍니다.',
    ...
    'library.section.empty.body': '이 섹션은 사람이 검수한 공개 데이터만 표시합니다. 승인된 항목이 추가되면 이 페이지에 나타납니다.',
    'library.featured-resources': 'Featured Resources',
    'library.featured-resources.description': '승인되고 사람이 검수한 공개 리소스만 표시합니다.',
    ...
    'library.featured-papers.description': '승인되고 사람이 검수한 AI 논문 카드만 표시합니다.',
    ...
    'library.review-note.title': '공개 전 검수 원칙',
    'library.review-note.body': 'Library의 공개 항목은 저장소에 들어가기 전에 사람이 검수합니다. AI 초안은 사용할 수 있지만, 사람의 검토 없이는 게시하지 않습니다.',
    'library.search-cta': '검색으로 이어보기',
  ...
  jp: {
    ...
    'library.title': 'ライブラリ',
    'library.subtitle': 'AIネイティブなビルダー向けの、人間が確認したリソースハブ',
    'library.description': 'デザイン、Vibe Coding、開発ドキュメント、AI論文、有用なフィード、発表資料を人間のレビュー後に整理する静的ライブラリです。',
    'library.human-reviewed': '人間が確認した公開データ',
    'library.sections.title': 'Libraryセクション',
    'library.sections.description': 'セクション別ページで、確認済みの公開サンプルをもう少し詳しく確認できます。',
    'library.section.design.title': 'Design',
    ...
    'library.section.ai-papers.title': 'AI Papers',
    'library.section.ai-papers.description': 'ビルダー視点で読む価値のあるAI論文カードを、人間が確認した要約と一緒に集めます。',
    'library.section.useful-feeds.title': 'Useful Feeds',
    ...
    'library.section.empty.body': 'このセクションでは、人間が確認した公開データだけを表示します。承認済みの項目が追加されるとここに表示されます。',
    'library.featured-resources': 'Featured Resources',
    'library.featured-resources.description': '承認済みで人間が確認した公開リソースだけを表示します。',
    'library.featured-topics': 'Featured Topics',
    'library.featured-topics.description': '論文推薦と今後のLibraryフィルターに使うアクティブなトピックです。',
    'library.featured-papers': 'Featured Papers',
    'library.featured-papers.description': '承認済みで人間が確認したAI論文カードだけを表示します。',
    ...
    'library.review-note.title': '公開前レビューの原則',
    'library.review-note.body': 'Libraryの公開項目はリポジトリに入る前に人間が確認します。AI下書きは使えますが、人間のレビューなしでは公開しません。',
    'library.search-cta': '検索で探す',
  ...
  en: {
    ...
    'library.subtitle': 'Human-reviewed resources for AI-native builders',
    'library.description': 'A static Library hub for reviewed design resources, vibe coding workflows, developer docs, AI papers, useful feeds, and presentation material.',
    'library.human-reviewed': 'Human-reviewed public data',
    'library.sections.title': 'Library Sections',
    'library.sections.description': 'Section pages now give each reviewed public sample a little more room.',
    'library.section.design.title': 'Design',
    ...
    'library.section.ai-papers.title': 'AI Papers',
    'library.section.ai-papers.description': 'Human-reviewed paper cards selected for builders and product-minded engineers.',
    'library.section.useful-feeds.title': 'Useful Feeds',
    ...
    'library.section.empty.body': 'This section only displays human-reviewed public data. Approved items will appear here after review.',
    'library.featured-resources': 'Featured Resources',
    'library.featured-resources.description': 'Only approved, human-reviewed public resources are displayed.',
    'library.featured-topics': 'Featured Topics',
    'library.featured-topics.description': 'Active topics for future paper recommendations and Library filtering.',
    'library.featured-papers': 'Featured Papers',
    'library.featured-papers.description': 'Only approved, human-reviewed AI paper cards are displayed.',
    ...
    'library.review-note.title': 'Review before publication',
    'library.review-note.body': 'Public Library entries are human-reviewed before they are committed. AI drafts may be used, but they are not published without human review.',
    'library.search-cta': 'Continue in search',
