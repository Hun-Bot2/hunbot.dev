...
export const ui = {
  ko: {
    ...
    'home.meta.title': "Hun-Bot's Devlog",
    'home.meta.description': 'AI 제품 개발, 빌드 로그, 논문과 도구 해석, 큐레이션을 연결해 기록하는 기술 블로그입니다.',
    'home.eyebrow': 'AI-native knowledge hub',
    'home.title': 'AI 제품을 만드는 과정을 기록합니다',
    'home.subtitle': '빌드 로그, 실험 노트, 논문과 도구 해석, 다시 찾아볼 리소스를 한곳에 모읍니다.',
    'home.description': '이 블로그는 개인 기술 기록이면서, AI-native builder를 위한 정적 지식 허브로 성장시키고 있는 공간입니다.',
    ...
    'home.focus.build.title': 'Build Logs',
    'home.focus.build.description': '실제로 만든 제품과 실험의 결정, 실패, 구현 과정을 남깁니다.',
    'home.focus.papers.title': 'Paper & Tool Notes',
    'home.focus.papers.description': '논문, 도구, 개발 워크플로우를 빌더 관점에서 짧고 실용적으로 해석합니다.',
    'home.focus.library.title': 'Curated Library',
    'home.focus.library.description': '디자인, 바이브 코딩, 개발 문서, AI 논문, 발표 자료를 다시 찾기 쉽게 정리합니다.',
    'blog.read-more': '더 읽기',
    'blog.all-posts': '모든 글',
    ...
    'library.title': '라이브러리',
    'library.subtitle': 'AI-native builders를 위한 실전 리소스 허브',
  ...
  jp: {
    ...
    'home.meta.title': "Hun-Bot's Devlog",
    'home.meta.description': 'AIプロダクト開発、ビルドログ、論文やツールの解釈、キュレーションをつなげて記録する技術ブログです。',
    'home.eyebrow': 'AI-native knowledge hub',
    'home.title': 'AIプロダクトを作る過程を記録します',
    'home.subtitle': 'ビルドログ、実験ノート、論文やツールの解釈、あとで参照したいリソースを一か所に集めます。',
    'home.description': 'このブログは個人の技術記録でありながら、AI-native builder向けの静的な知識ハブとして育てている場所です。',
    ...
    'home.focus.build.title': 'Build Logs',
    'home.focus.build.description': '実際に作ったプロダクトや実験の判断、失敗、実装過程を残します。',
    'home.focus.papers.title': 'Paper & Tool Notes',
    'home.focus.papers.description': '論文、ツール、開発ワークフローをビルダー視点で短く実用的に解釈します。',
    'home.focus.library.title': 'Curated Library',
    'home.focus.library.description': 'デザイン、Vibe Coding、開発ドキュメント、AI論文、発表資料を再訪しやすく整理します。',
    ...
    'library.title': 'ライブラリ',
    'library.subtitle': 'AIネイティブなビルダー向けの実用リソースハブ',
  ...
  en: {
    ...
    'footer.built-with': 'Built with:',
    'home.meta.title': "Hun-Bot's Devlog",
    'home.meta.description': 'A technical blog connecting AI product engineering, build logs, paper and tool notes, and curated resources.',
    'home.eyebrow': 'AI-native knowledge hub',
    'home.title': 'Documenting the work of building AI products',
    'home.subtitle': 'Build logs, experiment notes, paper and tool interpretations, and resources worth revisiting.',
    'home.description': 'This is a personal technical record growing into a static knowledge hub for AI-native builders.',
    ...
    'home.focus.build.title': 'Build Logs',
    'home.focus.build.description': 'Decisions, failures, and implementation notes from real products and experiments.',
    'home.focus.papers.title': 'Paper & Tool Notes',
    'home.focus.papers.description': 'Practical interpretations of papers, tools, and development workflows from a builder perspective.',
    'home.focus.library.title': 'Curated Library',
    'home.focus.library.description': 'Design, vibe coding, developer docs, AI papers, and presentation material organized for later use.',
    ...
    'library.subtitle': 'A practical resource hub for AI-native builders',
