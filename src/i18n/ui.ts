...
export const ui = {
  ko: {
    ...
    'library.sections.description': '상세 섹션 페이지는 이후 PR에서 열고, 현재 허브에서는 검수된 공개 샘플과 섹션 상태만 보여줍니다.',
  ...
  jp: {
    ...
    'library.sections.description': '詳細なセクションページは今後のPRで追加し、このハブでは確認済みの公開サンプルと状態だけを表示します。',
    'library.section.design.title': 'Design',
  ...
  en: {
    ...
    'library.sections.description': 'Detailed section pages are deferred to later PRs; this hub shows reviewed public samples and section status only.',
    'library.section.design.title': 'Design',
